...
class HeaderClass():
    ...
    def get_fields_count(self):
        holder = self.get_const_pool_length() + self.get_interfaces_count() + 33
        #print(format(self.data[holder], '02X'))
        #print(format(self.data[holder + 1], '02X'))
        return self.data[holder] + self.data[holder + 1]
    ...
    def get_fields(self):
        ...
        index = self.get_const_pool_length() + self.get_interfaces_count() + 33
        for i in range(count):
            temp.append(format(self.data[index + i], '02X'))
    ...
    def get_methods_count(self):
        holder = self.get_const_pool_length() + self.get_interfaces_count() + self.get_fields_count() + 35
        #print(format(self.data[holder], '02X'))
        #print(format(self.data[holder + 1], '02X'))
        return self.data[holder] + self.data[holder + 1]
    ...
    def get_methods(self):
        ...
        index = self.get_const_pool_length() + self.get_interfaces_count() + self.get_fields_count() + 35
